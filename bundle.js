...
/***/ function(module, exports, __webpack_require__) {
	...
	// Add creation
	var addMyCreation = function addMyCreation(event) {
	  var data = getFormFields(this);
	  // console.log('data:', data);
	  event.preventDefault();
	  api.addCreation(data).done(ui.addCreationSuccess).fail(ui.failure);
	};
	// Show all creations
	var showCreations = function showCreations() {
	  // console.log('HERE ARE YOUR CREATIONS');
	  api.viewCreations().done(ui.viewCreationsSuccess).fail(ui.failure);
	};

	var userCreations = function userCreations() {
	  api.viewUserCreations().done(ui.viewUserCreationsSuccess).fail(ui.failure);
	};

	// Show artist info
	var showArtist = function showArtist() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// ADD CREATION AJAX
	var addCreation = function addCreation(data) {
	  return $.ajax({
	...
	// View Creations
	var viewCreations = function viewCreations() {
	  return $.ajax({
	    url: app.api + '/creations',
	    method: 'GET',
	    headers: {
	...
	var viewUserCreations = function viewUserCreations() {
	  return $.ajax({
	...
	// view Artist
	var viewArtist = function viewArtist() {
	  return $.ajax({
	    url: app.api + '/users',
	    method: 'GET',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Add creation
	var addCreationSuccess = function addCreationSuccess(data) {
	  app.creation = data.creation;
	  console.log(app);
	};

	// handlebars view creations
	var displayCreations = function displayCreations(creations) {
	  // console.log('creations' + creations);
	  var creationTemplate = __webpack_require__(8);
	  $('.table').empty();
	...
	// View Creations
	var viewCreationsSuccess = function viewCreationsSuccess(data) {
	  console.log(data);
	...
	// handlebars view creations
	var displayUserCreations = function displayUserCreations(creations) {
	  // console.log('creations' + creations);
	  var userCreationTemplate = __webpack_require__(29);
	  $('.table').empty();
	...
	var viewUserCreationsSuccess = function viewUserCreationsSuccess(data) {
	  console.log(data);
	  displayUserCreations(data);
	};

	// handlebars view artist
	var displayArtist = function displayArtist(users) {
	  console.log('Artist' + users);
	  var artistTemplate = __webpack_require__(31);
	  $('.table').empty();
	...
	// View artist
	var viewArtistSuccess = function viewArtistSuccess(data) {
	  console.log(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.creations : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(28),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(30),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<tr>\n  <td style=\"color: #fff; font-size: 40px; text-align: center; \">username</td>\n</tr>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "91ef9c2e75082fe925f1534388daedf7.woff2";

/***/ },
/* 42 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "cd5a3ce9db461675c2f093f6420d27bb.woff";

/***/ },
/* 43 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "5f08a49b047e485aba215555817c40b4.jpg";
