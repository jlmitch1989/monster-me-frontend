...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayUserCreations = function displayUserCreations(creations) {
	  // console.log('creations' + creations);
	  var userCreationTemplate = __webpack_require__(28);
	  $('.all-creations').empty();
	...
	var displayArtist = function displayArtist(users) {
	  ...
	  var artistTemplate = __webpack_require__(29);
	  $('.all-artist').empty();
